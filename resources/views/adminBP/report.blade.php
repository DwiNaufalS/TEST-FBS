...
@section('title', 'Laporan Pemanggilan Antrian BP')

@section('content')
    <div class="container mt-5">
        <h2 class="text-center">Laporan Pemanggilan Antrian BP</h2>
        <div class="mt-4">
            <a href="{{ route('adminBP.exportExcel') }}" class="btn btn-success mt-3">Ekspor ke Excel</a>
            <a href="{{ route('adminBP.exportPDF') }}" class="btn btn-danger mt-3">Ekspor ke PDF</a>
            ...
            <div class="d-flex justify-content-between">
                <a href="{{ route('adminBP.dashboard') }}" class="btn btn-secondary mt-3">Kembali ke Dashboard</a>
                <div>
