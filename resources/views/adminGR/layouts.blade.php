    ...
    <div class="d-flex">
        <div class="sidebar bg-primary text-white p-4">
            ...
            <ul class="list-unstyled menu-list">
                <li>
                    <a href="{{ route('adminGR.dashboard') }}">
                        <i class="fas fa-tachometer-alt me-2"></i> Dashboard
                    </a>
                </li>
                <li>
                    <a href="{{ route('adminGR.callNextQueue', ['jenisAntrian' => 'GR']) }}">
                        <i class="fas fa-bell me-2"></i> Panggil Antrian GR
                    </a>
                </li>
                <li>
                    <a href="{{ route('adminGR.showReport') }}">
